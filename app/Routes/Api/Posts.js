...
module.exports = Route => {
  ...
  Route.post('posts', 'Api/PostController.create').middleware('auth').validator('PostValidator')
  Route.put('posts/:id', 'Api/PostController.update').middleware('auth').validator('PostValidator')
